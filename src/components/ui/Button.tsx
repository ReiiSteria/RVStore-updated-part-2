...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 shadow-sm focus:ring-purple-500',
    ...
    ghost: 'hover:bg-purple-50 text-purple-600 hover:text-purple-700 focus:ring-purple-500'
  };
